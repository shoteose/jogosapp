<?php if (isset($_SESSION['user_id_acess']) && $_SESSION['user_id_acess'] == 1) { ?>
  ...
  <body>
        ...
        <div class="container">
          ...
          <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3" id="jogosList">
            ...
            foreach ($data['jogos'] as $jogo) {
              ...
              echo '<a href="' . $url_alias . '/jogo/get/' . $jogo['id'] . '" class="btn btn-sm mt-auto btn-outline-secondary">Ver detalhes</a>';
              echo '<a href="' . $url_alias . '/jogo/update/' . $jogo['id'] . '" class="btn btn-sm mt-auto btn-outline-info">Editar Jogo</a>';
    ...
    <script src="<?php echo $url_alias ?>/assets/js/scriptsJo.js"></script>
  </body>
