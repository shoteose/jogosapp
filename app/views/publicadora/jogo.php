...
<body>
  ...
  <div class="form-body bg-image" style="background-image: url(<?php echo $url_alias ?>/assets/logos/<?php echo $data['jogos'][0]['caminho_imagem'] ?>)">
            ...
            <div class="form-items bg-dark shadow-lg mx-auto px-2 pt-3 rounded">
              ...
              <form action="<?php echo $url_alias; ?>/jogo/create" method="POST" enctype="multipart/form-data">
                <div class="col-md-12 mb-3">
                  <img class="img-fluid mx-auto d-block" src="<?php echo $url_alias ?>/assets/logos/<?php echo $data['jogos'][0]['caminho_imagem'] ?>">
                </div>
                ...
                <div class="form-button pb-3 text-center">
                  <a href= "<?php echo $url_alias;?>/publicadora/get/<?php echo $data['jogos'][0]['publicadora_id'];?>" class="btn btn-danger">Voltar</a>
                </div>
              </form>
            </div>
          </div>
